...
let cmiMessage = (() => {
  ...
  // test.setValue('D', 3, false, 1);
  // test.setValue('D', 4, false, 1);
  // test.setValue('D', 10, false, 1);
  // test.setValue('D', 10, false, 1);
  // test.setValue('D', 11, false, 1);
  // test.setKnot(52);
  // test.setIndex(9);
  // console.log(test.toString());
  //
  // const test2 = new Message();s
  // test2.setValue('A', 1, 12.2, 1, 2);
  // test2.setValue('A', 4, 12.2, 1, 2);
  // test2.setKnot(51);
  // test2.setIndex(4);
